...
class POP3 {
    ...
    */
     ...
     */
	public function __construct( $strLogFile = NULL, $bAPOPAutoDetect = TRUE, $bHideUsernameAtLog = TRUE, $strEncryption = TRUE, $bUseSockets = FALSE )
    {
	...
	public function connect( &$strHostname , $intPort = 110, $arrConnectionTimeout = array("sec" => 10, "usec" => 0) ,$bIPv6 = FALSE )
	{
        ...
        */
		...
		if( $this->bUseSockets ){
            ...
            $dTimeout = (double) implode(".",$arrConnectionTimeout); $intErrno = 0; $strError = "";
